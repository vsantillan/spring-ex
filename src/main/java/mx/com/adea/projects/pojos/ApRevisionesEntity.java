 ...
 */
@Entity
@Table(name = "AP_REVISIONES", schema = "VISANTILLAN", catalog = "")
public class ApRevisionesEntity {
	...
	public boolean equals(Object o) {
		...
		ApRevisionesEntity that = (ApRevisionesEntity) o;
		...
		if (noErrores != null ? !noErrores.equals(that.noErrores) : that.noErrores != null) return false;
