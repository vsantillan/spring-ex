 ...
 */
@Entity
@Table(name = "MGMT_PANTALLAS", schema = "VISANTILLAN", catalog = "")
public class MgmtPantallasEntity {
	...
	public boolean equals(Object o) {
		...
		MgmtPantallasEntity that = (MgmtPantallasEntity) o;
		...
		if (tipoValor != null ? !tipoValor.equals(that.tipoValor) : that.tipoValor != null)
			return false;
