 ...
 */
@Entity
@Table(name = "MGMT_MATRIZ_PRUEBAS", schema = "VISANTILLAN", catalog = "")
public class MgmtMatrizPruebasEntity {
	...
	public boolean equals(Object o) {
		...
		MgmtMatrizPruebasEntity that = (MgmtMatrizPruebasEntity) o;
		...
		if (datosPrueba != null ? !datosPrueba.equals(that.datosPrueba) : that.datosPrueba != null)
			return false;
