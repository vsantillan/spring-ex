 ...
 */
@Entity
@Table(name = "AP_REVISION", schema = "VISANTILLAN", catalog = "")
public class ApRevisionEntity {
	...
	public boolean equals(Object o) {
		...
		ApRevisionEntity that = (ApRevisionEntity) o;

		if (idEntrega != that.idEntrega) return false;
		if (idRevision != null ? !idRevision.equals(that.idRevision) : that.idRevision != null) return false;
		...
		if (autorizaPublicacion != null ? !autorizaPublicacion.equals(that.autorizaPublicacion) : that.autorizaPublicacion != null)
			return false;
		if (entregaManual != null ? !entregaManual.equals(that.entregaManual) : that.entregaManual != null) return false;
		if (entregaMatriz != null ? !entregaMatriz.equals(that.entregaMatriz) : that.entregaMatriz != null) return false;
