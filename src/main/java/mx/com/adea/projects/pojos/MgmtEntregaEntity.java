 ...
 */
@Entity
@Table(name = "MGMT_ENTREGA", schema = "VISANTILLAN", catalog = "")
public class MgmtEntregaEntity {
	...
	public boolean equals(Object o) {
		...
		MgmtEntregaEntity that = (MgmtEntregaEntity) o;

		if (hdEntrega != that.hdEntrega) return false;
		if (complejidad != that.complejidad) return false;
		if (tipoRevision != null ? !tipoRevision.equals(that.tipoRevision) : that.tipoRevision != null)
			return false;
		...
		if (requerimientoAplicacion != null ? !requerimientoAplicacion.equals(that.requerimientoAplicacion) : that.requerimientoAplicacion != null)
			return false;
		if (usoAplicacion != null ? !usoAplicacion.equals(that.usoAplicacion) : that.usoAplicacion != null)
			return false;
